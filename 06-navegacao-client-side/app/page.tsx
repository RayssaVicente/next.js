  ...
  return (
    <article className={styles.post}>
      ...
      <div className={`${styles.postContent}`}>
        <Image src="/saturno.jpg" alt="Saturno no espaço" width={600} height={307} />
        <p>
        ...
        <Image src="/aneissaturno.jpg" alt="Anéis de Saturno" width={600} height={328} />
        ...
        <Image src="/lua-saturno.jpg" alt="Luas de Saturno" width={600} height={315} />
      </div>
